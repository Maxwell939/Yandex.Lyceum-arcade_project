...
class GameView(arcade.View):
    ...
    def on_draw(self):
        self.clear()
        if self.horizontal_world == False:
    ...
    def on_update(self, delta_time):
        if self.horizontal_world == False:
            ...
            if self.score > 100 and self.horizontal_world == False:
...
class GameViewHorizontal(arcade.Window):
    def __init__(self):
        super().__init__(SCREEN_WIDTH + 1000, SCREEN_HEIGHT, SCREEN_TITLE)
